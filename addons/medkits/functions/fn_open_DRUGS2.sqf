...
for "_i" from 1 to 4 do {_this addItemToBackpack 'kat_EACA'};
for "_i" from 1 to 4 do {_this addItemToBackpack 'kat_phenylephrine'};
for "_i" from 1 to 4 do {_this addItemToBackpack 'kat_lidocaine'};
...
for "_i" from 1 to 3 do {_this addItemToBackpack 'kat_nitroglycerin'};
